...
module.exports = {
  ...
  rules   : {
    ...
    //Temporarily disabled 'no-magic-numbers'                  : [1, { ignore: [-1, 0, 1], ignoreArrayIndexes: true }],
    'no-restricted-properties'          : [2, { object: 'describe', property: 'only' }, { object: 'it', property: 'only' }],
    'no-return-await'                   : 2,
    //Temporarily disabled 'no-unused-expressions'             : 1,
    ...
    //Temporarily disabled 'camelcase'                         : 1,
    'consistent-this'                   : [2, 'self'],
    //Temporarily disabled 'max-nested-callbacks'              : [1, 3],
    'max-statements-per-line'           : ['error', { max: 1 }],
    //Temporarily disabled 'max-depth'                         : [1, 5],
